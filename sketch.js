...
function setup() {
  ...
  invisibleGround = createSprite(800, 610, 3600, 50);
...
function draw() {
  ...
  camera.position.x = forest.x;
  camera.position.y = forest.y;
